...
describe("Deployment", () => {
  test("Deploy Blockchains contract", async () => {
    const name = "Blockchains";
...
describe("Transactions", () => {
  test("test transaction template Transaction", async () => {
    ...
    const JacobTucker = await getContractAddress("JacobTucker");
  ...
  test("test transaction template Mod3Proj", async () => {
    const name = "Mod3Proj";
    ...
    // Define arguments
    const args = [["Hello", "Hello", "Hello", "Hello", types.String]];

    // Generate addressMap from import statements
    const Blockchains = await getContractAddress("Blockchains");
...
describe("Scripts", () => {
  ...
  test("test script template Mod3Proj", async () => {
    const name = "Mod3Proj";
